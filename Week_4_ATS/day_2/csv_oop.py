...
profile1 = Profile('ahmadsharaf', 'Ahmad', 'Sharafudeen', 'Ahmad2022')#, '07066402941', 'Akobo, Ibadan', '09/03', 'male')
# profile1.signin(input('Username: '), input('Password: '))
profile2 = Profile('awwalade', 'Awwal', 'Adeleke', 'AdElEke21')#, '07066402941', 'Akobo, Ibadan', '09/03', 'male')
